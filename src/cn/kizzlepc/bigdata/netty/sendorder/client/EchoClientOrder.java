package cn.kizzlepc.bigdata.netty.sendorder.client;
 ...
 *
 */
public class EchoClientOrder {

	private final String host;
	private final int port;

	public EchoClientOrder(String host, int port) {
		this.host = host;
		this.port = port;
	}
	...
	public static void main(String[] args) throws Exception {
		new EchoClientOrder("localhost", 20000).start();
	}
}
